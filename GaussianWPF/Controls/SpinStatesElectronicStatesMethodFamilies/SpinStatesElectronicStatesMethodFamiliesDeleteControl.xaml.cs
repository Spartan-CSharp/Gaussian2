...
/// <summary>
/// Interaction logic for SpinStatesElectronicStatesMethodFamiliesDeleteControl.xaml
/// </summary>
public partial class SpinStatesElectronicStatesMethodFamiliesDeleteControl : UserControl, INotifyPropertyChanged
{
	private readonly ILogger<SpinStatesElectronicStatesMethodFamiliesDeleteControl> _logger;
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="SpinStatesElectronicStatesMethodFamiliesDeleteControl"/> class with dependency injection.
	/// </summary>
	...
	/// </summary>
	public event EventHandler<ChildControlEventArgs<SpinStatesElectronicStatesMethodFamiliesDeleteControl>>? ChildControlEvent;

	/// <summary>
	/// Gets or sets the Spin State/Electronic State/Method Family Combination view model being deleted.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	/// Gets or sets the identifier of the Spin State/Electronic State/Method Family Combination to delete.
	/// </summary>
	/// <remarks>
	...
	protected void OnPropertyChanged([CallerMemberName] string? propertyName = null)
	{
		...
		{
			_logger.LogDebug("{UserControl} {Method} called with CallerMemberName = {PropertyName}.", nameof(SpinStatesElectronicStatesMethodFamiliesDeleteControl), nameof(OnPropertyChanged), propertyName);
		}
		...
		if (_logger.IsEnabled(LogLevel.Debug))
		{
			_logger.LogDebug("{UserControl} {Method} returning.", nameof(SpinStatesElectronicStatesMethodFamiliesDeleteControl), nameof(OnPropertyChanged));
		}
	}
	...
	protected override void OnInitialized(EventArgs e)
	{
		if (_logger.IsEnabled(LogLevel.Debug))
		{
			_logger.LogDebug("{UserControl} {EventHandler} called with {EventArgs}.", nameof(SpinStatesElectronicStatesMethodFamiliesDeleteControl), nameof(OnInitialized), e);
		}

		base.OnInitialized(e);
		DataContext = this;
		PropertyChanged += SpinStatesElectronicStatesMethodFamiliesDeleteControl_PropertyChanged;

		if (_logger.IsEnabled(LogLevel.Debug))
		{
			_logger.LogDebug("{UserControl} {EventHandler} returning.", nameof(SpinStatesElectronicStatesMethodFamiliesDeleteControl), nameof(OnInitialized));
		}
	}

	private void SpinStatesElectronicStatesMethodFamiliesDeleteControl_PropertyChanged(object? sender, PropertyChangedEventArgs e)
	{
		if (_logger.IsEnabled(LogLevel.Debug))
		{
			_logger.LogDebug("{UserControl} {EventHandler} called with {Sender} and {EventArgs}.", nameof(SpinStatesElectronicStatesMethodFamiliesDeleteControl), nameof(SpinStatesElectronicStatesMethodFamiliesDeleteControl_PropertyChanged), sender, e);
		}
		...
		if (e.PropertyName is nameof(SpinStateElectronicStateMethodFamilyId))
		{
			...
			catch (HttpIOException ex)
			{
				...
				{
					_logger.LogError(ex, "{UserControl} {EventHandler} called with {Sender} and {EventArgs} had an error.", nameof(SpinStatesElectronicStatesMethodFamiliesDeleteControl), nameof(SpinStatesElectronicStatesMethodFamiliesDeleteControl_PropertyChanged), sender, e);
				}
			}
		...
		if (_logger.IsEnabled(LogLevel.Debug))
		{
			_logger.LogDebug("{UserControl} {EventHandler} returning.", nameof(SpinStatesElectronicStatesMethodFamiliesDeleteControl), nameof(SpinStatesElectronicStatesMethodFamiliesDeleteControl_PropertyChanged));
		}
	}
	...
	private void DeleteButton_Click(object sender, RoutedEventArgs e)
	{
		try
		{
			if (_logger.IsEnabled(LogLevel.Debug))
			{
				_logger.LogDebug("{UserControl} {EventHandler} called with {Sender} and {EventArgs}.", nameof(SpinStatesElectronicStatesMethodFamiliesDeleteControl), nameof(DeleteButton_Click), sender, e);
			}

			ErrorMessage = string.Empty;
			_spinStatesElectronicStatesMethodFamiliesEndpoint.DeleteAsync(SpinStateElectronicStateMethodFamilyId).Wait();
			SpinStateElectronicStateMethodFamily!.LastUpdatedDate = DateTime.Now;
			SpinStateElectronicStateMethodFamily!.Archived = true;
			ChildControlEvent?.Invoke(this, new ChildControlEventArgs<SpinStatesElectronicStatesMethodFamiliesDeleteControl>("delete", null));

			if (_logger.IsEnabled(LogLevel.Debug))
			{
				_logger.LogDebug("{UserControl} {EventHandler} returning.", nameof(SpinStatesElectronicStatesMethodFamiliesDeleteControl), nameof(DeleteButton_Click));
			}
		}
		catch (HttpIOException ex)
		{
			...
			if (_logger.IsEnabled(LogLevel.Error))
			{
				_logger.LogError(ex, "{UserControl} {EventHandler} called with {Sender} and {EventArgs} had an error.", nameof(SpinStatesElectronicStatesMethodFamiliesDeleteControl), nameof(DeleteButton_Click), sender, e);
			}
		}
		catch (AggregateException ae)
		{
	...
	private void BackToIndexButton_Click(object sender, RoutedEventArgs e)
	{
		if (_logger.IsEnabled(LogLevel.Debug))
		{
			_logger.LogDebug("{UserControl} {EventHandler} called with {Sender} and {EventArgs}.", nameof(SpinStatesElectronicStatesMethodFamiliesDeleteControl), nameof(BackToIndexButton_Click), sender, e);
		}

		ChildControlEvent?.Invoke(this, new ChildControlEventArgs<SpinStatesElectronicStatesMethodFamiliesDeleteControl>("index", null));

		if (_logger.IsEnabled(LogLevel.Debug))
		{
			_logger.LogDebug("{UserControl} {EventHandler} returning.", nameof(SpinStatesElectronicStatesMethodFamiliesDeleteControl), nameof(BackToIndexButton_Click));
		}
	}
}
