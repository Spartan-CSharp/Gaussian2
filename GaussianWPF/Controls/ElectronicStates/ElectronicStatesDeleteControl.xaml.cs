...
/// <summary>
/// Interaction logic for ElectronicStatesDeleteControl.xaml
/// </summary>
public partial class ElectronicStatesDeleteControl : UserControl, INotifyPropertyChanged
{
	private readonly ILogger<ElectronicStatesDeleteControl> _logger;
	...
	protected void OnPropertyChanged([CallerMemberName] string? propertyName = null)
	{
		...
		{
			_logger.LogDebug("{UserControl} {Method} called with CallerMemberName = {PropertyName}.", nameof(ElectronicStatesDeleteControl), nameof(OnPropertyChanged), propertyName);
		}
		...
		if (_logger.IsEnabled(LogLevel.Debug))
		{
			_logger.LogDebug("{UserControl} {Method} returning.", nameof(ElectronicStatesDeleteControl), nameof(OnPropertyChanged));
		}
	}
	...
	protected override void OnInitialized(EventArgs e)
	{
		if (_logger.IsEnabled(LogLevel.Debug))
		{
			_logger.LogDebug("{UserControl} {EventHandler} called with {EventArgs}.", nameof(ElectronicStatesDeleteControl), nameof(OnInitialized), e);
		}

		base.OnInitialized(e);
		DataContext = this;
		PropertyChanged += ElectronicStatesDeleteControl_PropertyChanged;

		if (_logger.IsEnabled(LogLevel.Debug))
		{
			_logger.LogDebug("{UserControl} {EventHandler} returning.", nameof(ElectronicStatesDeleteControl), nameof(OnInitialized));
		}
	}

	private void ElectronicStatesDeleteControl_PropertyChanged(object? sender, PropertyChangedEventArgs e)
	{
		if (_logger.IsEnabled(LogLevel.Debug))
		{
			_logger.LogDebug("{UserControl} {EventHandler} called with {Sender} and {EventArgs}.", nameof(ElectronicStatesDeleteControl), nameof(ElectronicStatesDeleteControl_PropertyChanged), sender, e);
		}
		...
		if (e.PropertyName is nameof(ElectronicStateId))
		{
			...
			catch (HttpIOException ex)
			{
				...
				{
					_logger.LogError(ex, "{UserControl} {EventHandler} called with {Sender} and {EventArgs} had an error.", nameof(ElectronicStatesDeleteControl), nameof(ElectronicStatesDeleteControl_PropertyChanged), sender, e);
				}
			}
		...
		if (_logger.IsEnabled(LogLevel.Debug))
		{
			_logger.LogDebug("{UserControl} {EventHandler} returning.", nameof(ElectronicStatesDeleteControl), nameof(ElectronicStatesDeleteControl_PropertyChanged));
		}
	}
	...
	private void DeleteButton_Click(object sender, RoutedEventArgs e)
	{
		try
		{
			if (_logger.IsEnabled(LogLevel.Debug))
			{
				_logger.LogDebug("{UserControl} {EventHandler} called with {Sender} and {EventArgs}.", nameof(ElectronicStatesDeleteControl), nameof(DeleteButton_Click), sender, e);
			}

			ErrorMessage = string.Empty;
			_endpoint.DeleteAsync(ElectronicStateId).Wait();
			ElectronicState!.LastUpdatedDate = DateTime.Now;
			ElectronicState!.Archived = true;
			ChildControlEvent?.Invoke(this, new ChildControlEventArgs<ElectronicStatesDeleteControl>("delete", null));

			if (_logger.IsEnabled(LogLevel.Debug))
			{
				_logger.LogDebug("{UserControl} {EventHandler} returning.", nameof(ElectronicStatesDeleteControl), nameof(DeleteButton_Click));
			}
		}
		catch (HttpIOException ex)
		{
			...
			if (_logger.IsEnabled(LogLevel.Error))
			{
				_logger.LogError(ex, "{UserControl} {EventHandler} called with {Sender} and {EventArgs} had an error.", nameof(ElectronicStatesDeleteControl), nameof(DeleteButton_Click), sender, e);
			}
		}
		catch (AggregateException ae)
		{
	...
	private void BackToIndexButton_Click(object sender, RoutedEventArgs e)
	{
		if (_logger.IsEnabled(LogLevel.Debug))
		{
			_logger.LogDebug("{UserControl} {EventHandler} called with {Sender} and {EventArgs}.", nameof(ElectronicStatesDeleteControl), nameof(BackToIndexButton_Click), sender, e);
		}

		ChildControlEvent?.Invoke(this, new ChildControlEventArgs<ElectronicStatesDeleteControl>("index", null));

		if (_logger.IsEnabled(LogLevel.Debug))
		{
			_logger.LogDebug("{UserControl} {EventHandler} returning.", nameof(ElectronicStatesDeleteControl), nameof(BackToIndexButton_Click));
		}
	}
}
